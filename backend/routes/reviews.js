...
// Get reviews for a specific hotel by ID
...
router.post('/', protect, async (req, res) => {
  try {
    ...
    // VALIDATE: Only allow if user has booked this hotel before
    // We check Booking model where userId matches and hotelId matches
    ...
    // Optionally trigger update the overarching 'Hotel' review count/number
